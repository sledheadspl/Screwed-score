...
import { ArrowRight, Download, Cpu, FileText, TrendingUp, Layout, Zap, Star, Loader2, Brain, Mail, Video, Search, Link2, Mic, Shield, BookOpen, Clock, BarChart2 } from 'lucide-react'
...
const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    desc: '500+ battle-tested prompts for content creation, copywriting, strategy, and ideation. Plug directly into ChatGPT or Claude and produce elite output instantly.',
    price: '$79',
    badge: 'Hot',
    badgeColor: 'rgba(255,107,96,0.9)',
  },
  {
    ...
    desc: 'Proven email templates, monetization sequences, and a 90-day growth playbook to turn your newsletter into a revenue-generating asset.',
    price: '$59',
    badge: null,
    badgeColor: '',
  },
  {
    id: 'video-repurpose-kit',
    icon: Video,
    category: 'Automation',
    title: 'Video Repurposing Masterkit',
    desc: 'Turn one long-form video into 15+ pieces of content. Includes SOP, cut templates, caption workflows, and a full distribution checklist.',
    price: '$44',
    badge: null,
    badgeColor: '',
  },
  {
    id: 'seo-content-matrix',
    icon: Search,
    category: 'Systems',
    title: 'SEO Content Matrix',
    desc: 'Research-to-publish content system engineered for organic traffic. Keyword clustering, content briefs, internal linking strategy, and a Notion tracker.',
    price: '$69',
    badge: null,
    badgeColor: '',
  },
  {
    ...
    title: 'Affiliate Revenue Stack',
    desc: 'Build passive affiliate income with plug-and-play systems. Includes link tracking setup, disclosure templates, content formats, and a monthly review SOP.',
    price: '$54',
    badge: null,
    badgeColor: '',
  },
  {
    id: 'podcast-launch-kit',
    icon: Mic,
    category: 'Launch',
    title: 'Podcast Launch Kit',
    desc: 'Everything you need to launch and monetize a podcast in 30 days. Cover art brief, episode structure templates, sponsor pitch deck, and a distribution checklist.',
    price: '$79',
    badge: null,
    badgeColor: '',
  },
  {
    id: 'creator-legal-pack',
    icon: Shield,
    category: 'Templates',
    title: 'Creator Legal Pack',
    desc: 'Professional contracts, disclaimers, and TOS templates written for online creators. Covers brand deals, coaching, digital products, and UGC agreements.',
    price: '$129',
    badge: 'Essential',
  ...
  },
  {
    ...
    icon: BarChart2,
    category: 'Monetization',
    title: 'Email Monetization Playbook',
    desc: 'Proven sequences, offer frameworks, and segmentation strategies to convert your email list into predictable recurring revenue — without burning out your audience.',
    price: '$84',
    badge: null,
    badgeColor: '',
  },
  {
    ...
    desc: 'End-to-end system to outline, build, and sell an online course. Includes curriculum framework, sales page template, pricing strategy, and launch timeline.',
    price: '$119',
    badge: 'New',
    badgeColor: 'rgba(48,209,88,0.8)',
  },
  {
    ...
    title: 'Elite Time Blocking System',
    desc: 'Calendar architecture and Google Calendar templates built for creators who need to protect deep work. Includes weekly rhythm guide and energy audit worksheet.',
    price: '$39',
    badge: null,
    badgeColor: '',
  },
